package com.yacoding.xt.web.domain;
...
import com.yacoding.xt.web.model.NewsModel;
import com.yacoding.xt.web.model.enums.TabEnum;
...
public class NewsDomain {
    ...
    public CallResult<Object> checkNewsListParam() {
        ...
        if (TabEnum.valueOfCode(tab) == null){//不存在--参数不正确
            return CallResult.fail(BusinessCodeEnum.CHECK_PARAM_NO_RESULT.getCode(),"参数不正确");
        }
